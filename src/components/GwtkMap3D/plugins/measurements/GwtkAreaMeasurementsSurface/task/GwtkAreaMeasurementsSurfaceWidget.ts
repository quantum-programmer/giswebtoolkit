 ...
 ********************************************************************
 *                                                                  *
 *           Виджет задачи "Измерения площади по поверхности"       *
 *                                                                  *
 *                                                                  *
 *******************************************************************/
...
import {
    GwtkAreaMeasurementsSurfaceTaskState,
    TOGGLE_NEW_MEASUREMENT,
    TOGGLE_RESUME,
    TOGGLE_SEGMENT_DETAILS,
    TOGGLE_EXPORT_TO_CSV
} from './GwtkAreaMeasurementsSurfaceTask';
...
@Component
export default class GwtkAreaMeasurementsSurfaceWidget extends BaseGwtkVueComponent {
    @Prop( { default: '' } )
    ...
    @Prop( { default: () => ({}) } )
    private readonly setState!: <K extends keyof GwtkAreaMeasurementsSurfaceTaskState>( key: K, value: GwtkAreaMeasurementsSurfaceTaskState[K] ) => void;
