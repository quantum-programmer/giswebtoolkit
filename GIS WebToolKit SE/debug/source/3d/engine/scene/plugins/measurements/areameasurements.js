...
if (window.GWTK) {
     ...
     * @class GWTK.gEngine.Plugins.AreaMeasurementLayer
     * @constructor GWTK.gEngine.Plugins.AreaMeasurementLayer
     * @extends GWTK.UserControl
     */
    GWTK.gEngine.Plugins.AreaMeasurementLayer = function() {
        this.title = "Area measurements";
        this.id = "panel_button_areameasurements3d";
    };
    GWTK.gEngine.Plugins.AreaMeasurementLayer.prototype = {
        /**
         * Инициализация
         * @method init
         * @public
     ...
     * @class GWTK.gEngine.Plugins.AreaMeasurementInfoView
     * @constructor GWTK.gEngine.Plugins.AreaMeasurementInfoView
     ...
     */
    GWTK.gEngine.Plugins.AreaMeasurementInfoView = function(controller) {
        this._pointList = [];
    ...
    GWTK.gEngine.Plugins.AreaMeasurementInfoView.prototype = {
        /**
         * Инициализация
         * @method _init
         * @private
        ...
        updateValues: function(obb, measurementResults, hideDeleteElements) {
            ...
            GWTK.gEngine.Mediator.publish('tool3dAreaMeasurements', measurementResults);
