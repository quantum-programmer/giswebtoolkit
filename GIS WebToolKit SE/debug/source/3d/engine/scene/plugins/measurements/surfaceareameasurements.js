 ...
 ********************************************************************
 *                                                                  *
 *        Компонент измерения площади земной поверхности            *
 *                                                                  *
 *******************************************************************/
"use strict";
...
if (window.GWTK) {
    ...
    /**
     * Класс слоя измерения площади
     * @class GWTK.gEngine.Plugins.SurfaceAreaMeasurementLayer
     * @constructor GWTK.gEngine.Plugins.SurfaceAreaMeasurementLayer
     * @extends GWTK.UserControl
     */
    GWTK.gEngine.Plugins.SurfaceAreaMeasurementLayer = function() {
        this.title = "Area measurements by surface";
        this.id = "panel_button_surfaceareameasurements3d";
    };
    GWTK.gEngine.Plugins.SurfaceAreaMeasurementLayer.prototype = {
        /**
         * Инициализация
         * @method init
         * @public
     ...
     * @class GWTK.gEngine.Plugins.SurfaceAreaMeasurementInfoView
     * @constructor GWTK.gEngine.Plugins.SurfaceAreaMeasurementInfoView
     ...
     */
    GWTK.gEngine.Plugins.SurfaceAreaMeasurementInfoView = function(controller) {
        this._pointList = [];
    ...
    GWTK.gEngine.Plugins.SurfaceAreaMeasurementInfoView.prototype = {
        /**
         * Инициализация
         * @method _init
         * @private
        ...
        updateValues: function(obb, measurementResults, hideDeleteElements) {
            ...
            GWTK.gEngine.Mediator.publish('tool3dAreaMeasurementsSurface', measurementResults);
