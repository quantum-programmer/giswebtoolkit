    ...
    var maptree = [
        {
            ...
            "nodes": [
                { "id": "fon_noginsk", "text": "Богородский городской округ", "clickable": true, "img": "ico_panorama" }//,
        ...
        },
        {
            ...
            "nodes": [
                { "id": "infrastruct", "text": "Карта гостя", "clickable": true, "img": "icon-page" },
                { "id": "noginsk", "text": "Ногинск", "clickable": true, "img": "icon-page" }
            ]
        },
        {
            "id": "map2", "text": "Геопорталы", "img": "icon-folder", "expanded": true,
            "nodes": [
                { "id": "site1", "text": "<a href ='http://3d.gisserver.ru' target='_blank'>Ногинск 3D</a>", "clickable": false, "img": "ico_panorama" },
                { "id": "site2", "text": "<a href ='http://gisserver.ru/giswebserverse/index.php?projectid=2' target='_blank'>Карта Мира</a>", "clickable": false, "img": "ico_panorama" }
            ]
        }
    ];
    ...
    var options = {
        ...
        "layers": [
                    ...
                    // },
                    {
                        ...
                        "selectObject": 0,
                        //"schemename":"map5000m", "selectObject": 1,
                        "waterColors":[
                            "#a8c1c1",
                            "#81a1c1",
                            "#94afc8",
                        ...
                        "url": "SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=noginsk_area&STYLE=default&TILEMATRIXSET=%tilematrixset&TILEMATRIX=%z&TILEROW=%y&TILECOL=%x&FORMAT=image/png8",
                        "hidden": 1
                    },
                    {
                        "id": "noginsk",
                        "alias": "Noginsk",
                        "selectObject": 1, "version":"13.3.0",
                        "url": "SERVICE=WMS&REQUEST=GetMap&VERSION=1.3.0&FORMAT=image/png&LAYERS=noginsk_area&BBOX=%bbox&HEIGHT=%h&WIDTH=%w&CRS=%crs",
                        "hidden": 0, "schemename":"map5000m",
                        "areapixel": 20,
                        "keyssearchbyname": ["Name"]
                    },
                    {
                        "id": "infrastruct",
                        "alias": "Карта гостя", "areapixel": 15,
                        "selectObject": 1, "schemename":"guestmap",
                        "export": ['gml','json'],
        ...
        "areasearch", "selectobjects", "clearselect", "content", "map3d", "localmapcontrol",
        "mapeditor", "mapcalculations", "thematicmapcontrol", "viewentirelayer", "transitiontopoint", "ruler", "polygonarea", "viewoptions","mapmenu","map2img"],
