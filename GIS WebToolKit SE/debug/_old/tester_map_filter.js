...
function initMap() {
    ...
    var maptree = [
        {
            "id": "fon", "text": "Фоновые слои", "img": "icon-folder", "expanded": false,
        ...
        },
        {
            ...
            "nodes": [{ "id": "infrastruct", "text": "Карта гостя", "clickable": true, "img": "icon-page" },
                      { "id": "noginsk_area", "text": "Богородский городской округ", "clickable": true, "img": "icon-page" }
                      ,{ "id": "noginsk0001", "text": "Ногинск кварталы", "clickable": true, "img": "icon-page" }
                      ,{ "id": "noginsk0002", "text": "Ногинск коды", "clickable": true, "img": "icon-page" }
            ]
        }
    ];
    ...
    var options = {
        ...
        "showsettings": false, "mergewmslayers":true,
        ...
        "layers": [
                   ...
                   /*{
                    ...
                    },*/
                    {
                        ...
                        "export": 1,
                        "version": '13.3.0',
                        "url": "http://localhost/GISWebServiceSE/service.php?SERVICE=WMS&REQUEST=GetMap&VERSION=1.3.0&FORMAT=image/png&LAYERS=noginsk_area&BBOX=%bbox&HEIGHT=%h&WIDTH=%w&CRS=%crs",
                        "hidden": 1,
                        "legend": "publicfacil",  //"*",
                    ...
                    },
                    {
                        "id": "noginsk0001",
                        "alias": "noginskTypes",
                        "selectObject": 1,                 //&typenames=Hydrography,Settlements,SettlementBlock
                        "url": "http://localhost/GISWebServiceSE/service.php?SERVICE=WMS&REQUEST=GetMap&VERSION=1.3.0&FORMAT=image/png&LAYERS=0001&BBOX=%bbox&HEIGHT=%h&WIDTH=%w&CRS=%crs&codelist=41100000,41200000,43100000,42100000,43400000,45100000",
                        "hidden": 0, 
                        "version": '13.3.0',
                        "legend":"SettlementBlock",
                        "shortlegend":1,
                    },
                    {
                        "id": "noginsk0002",
                        "alias": "noginskcodes",
                        "selectObject": 1,
                        "url": "http://localhost/GISWebServiceSE/service.php?SERVICE=WMS&REQUEST=GetMap&VERSION=1.3.0&FORMAT=image/png&LAYERS=0001&BBOX=%bbox&HEIGHT=%h&WIDTH=%w&CRS=%crs&codelist=31120000,31131000,45111000,45112000",
                        "hidden": 0,
                        "version": '13.3.0', 
                        "legend":"Hydrography,SettlementBlock",
                        "shortlegend":1,
                    },
                    {
                        "id": "infrastruct",
